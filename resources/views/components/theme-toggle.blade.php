<button @click="darkMode=!darkMode" type="button"
    class="relative inline-flex flex-shrink-0 h-6 transition-colors duration-200 ease-in-out
            border-2 border-transparent rounded-full cursor-pointer bg-pink-220 dark:bg-zinc-510
            w-11 focus:outline-none focus:ring-1 focus:ring-neutral-700 focus:ring-offset-1"
    role="switch" aria-checked="false">
    <span class="sr-only">Use setting</span>
    <span class="relative inline-block w-5 h-5 transition duration-500 ease-in-out transform translate-x-0 bg-azure rounded-full shadow pointer-events-none dark:translate-x-5 ring-0">
